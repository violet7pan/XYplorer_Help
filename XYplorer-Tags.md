...
![Tags-Label](_resources/Tags-Label.png)
...
![Tags-LabelAndTag](_resources/Tags-LabelAndTag.png)
...
![ColumnLayout-Save-1](_resources/ColumnLayout-Save-1%201.png)

![ColumnLayout-Save-2](_resources/ColumnLayout-Save-2%201.png)

由于我有四列，**请按照列表顺序命名，方便区分和加载**，由此我的命名为Modified-Ext-Size-Created.txt。

-添加新列Label, Tag, Comment

![CustomColumn-Add-1](_resources/CustomColumn-Add-1.png)
...
![CurpathSearchByTags.xys](_resources/CurpathSearchByTags.xys.gif)
...
![Script-CurpathSearchByTags](_resources/Script-CurpathSearchByTags.png)
...
![Script-CurpathSearchByTags-2](_resources/Script-CurpathSearchByTags-2.png)
